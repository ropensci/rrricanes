...
df.al162001.prblty <- get_prblty(al2001[16])
...
load(system.file("extdata", "al162001.prblty.Rda", package = "Hurricanes"))
...
test_that("Test prblty", {
    ...
    expect_identical(al162001.prblty, df.al162001.prblty)
})