...
test_that("HTML format", {
  ...
  #' 2005
  expect_identical(
    v(1, 1, sprintf("%sarchive/2005/", get_nhc_link())),
    "Tropical Storm ARLENE"
  )
  expect_identical(
    v(31, 2, sprintf("%sarchive/2005/", get_nhc_link())),
    "Tropical Depression SIXTEEN-E"
  )
  expect_identical(
    v(59, 1, sprintf("%sarchive/2005/", get_nhc_link())),
    "Tropical Storm ZETA"
  )
  ## ---- * * 2016 -------------------------------------------------------------
  #' 2016
  expect_identical(
    v(29, 1, sprintf("%sarchive/2016/", get_nhc_link())),
    "Hurricane NICOLE"
  )
  expect_identical(
    v(41, 2, sprintf("%sarchive/2016/", get_nhc_link())),
    "Tropical Storm TINA"
  )
})
...
test_that("Column Names", {
  expect_named(
    get_storms(2016, basin = "AL"),
    c("Year", "Name", "Basin", "Link")
  )
  expect_named(
    get_storms(2016, basin = "EP"),
    c("Year", "Name", "Basin", "Link")
  )
})
...
test_that("Get Storm List", {
  ...
  expect_identical(
    ...
    c(
      "STORM_NAME", "RE", "X", "R2", "R3", "R4", "R5", "CY", "YYYY", "TY", "I",
