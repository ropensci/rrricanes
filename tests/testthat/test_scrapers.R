...
test_that("scrape_header", {
  ...
  expect_identical(
    rrricanes:::scrape_header(read_files(files$AL011991$fstadv[1]), ptn_product_title = "(?:\n?SPECIAL\\s+)?(?:FORECAST/|MARINE\\s+)?(?:ADVISORY)?"),
  ...
  expect_identical(
    rrricanes:::scrape_header(read_files(files$AL012001$fstadv[1]), ptn_product_title = "(?:\n?SPECIAL\\s+)?(?:FORECAST/|MARINE\\s+)?(?:ADVISORY)?"),
  ...
  expect_identical(
    rrricanes:::scrape_header(read_files(files$AL012001$fstadv[2]), ptn_product_title = "(?:\n?SPECIAL\\s+)?(?:FORECAST/|MARINE\\s+)?(?:ADVISORY)?"),
  ...
  expect_identical(
    rrricanes:::scrape_header(read_files(files$AL012003$fstadv[1]), ptn_product_title = "(?:\n?SPECIAL\\s+)?(?:FORECAST/|MARINE\\s+)?(?:ADVISORY)?"),
  ...
  expect_identical(
    rrricanes:::scrape_header(read_files(files$AL012004$fstadv[1]), ptn_product_title = "(?:\n?SPECIAL\\s+)?(?:FORECAST/|MARINE\\s+)?(?:ADVISORY)?"),
    c("Hurricane", "Alex", "12")
  )
  ...
  expect_identical(
    rrricanes:::scrape_header(read_files(files$AL012011$fstadv[1]), ptn_product_title = "(?:\n?SPECIAL\\s+)?(?:FORECAST/|MARINE\\s+)?(?:ADVISORY)?"),
  ...
  expect_identical(
    rrricanes:::scrape_header(read_files(files$AL012012$fstadv[1]), ptn_product_title = "(?:\n?SPECIAL\\s+)?(?:FORECAST/|MARINE\\s+)?(?:ADVISORY)?"),
  ...
  expect_identical(
    rrricanes:::scrape_header(read_files(files$AL022017$fstadv[1]), ptn_product_title = "(?:\n?SPECIAL\\s+)?(?:FORECAST/|MARINE\\s+)?(?:ADVISORY)?"),
 ...
 # expect_identical(
  ...
  expect_identical(
    rrricanes:::scrape_header(read_files(files$AL102008$fstadv[1]), ptn_product_title = "(?:\n?SPECIAL\\s+)?(?:FORECAST/|MARINE\\s+)?(?:ADVISORY)?"),
  ...
  expect_identical(
    rrricanes:::scrape_header(read_files(files$CP031994$fstadv[1]), ptn_product_title = "(?:\n?SPECIAL\\s+)?(?:FORECAST/|MARINE\\s+)?(?:ADVISORY)?"),
