...
#' @source \url{http://www.nhc.noaa.gov/archive/2012/}
"df.al_2012"

#' Strike probabilities for Hurricane Katrina (AL122005)
#' @source \url{http://www.nhc.noaa.gov/archive/2005/KATRINA.shtml?}
"df.al_12_2005_prblty"

#' Wind speed probabilities for Hurricane Sandy (AL182012)
#' @source \url{http://www.nhc.noaa.gov/archive/2012/SANDY.shtml?}
...
#' @source \url{http://www.nhc.noaa.gov/gis/archive_wsp.php}
"df.gis_wsp"
