...
p + 
  geom_sf(
    data = sf::st_as_sf(df.gis_wsp$`2016100606_wsp34knt120hr_halfDeg`), 
    aes(color = PWIND120)
  ) +
...
p + 
  geom_sf(
    data = sf::st_as_sf(df.gis_wsp$`2016100606_wsp50knt120hr_halfDeg`), 
    aes(color = PWIND120)
  ) +
  coord_sf(xlim = c(bb[1,1], bb[1,2]), ylim = c(bb[2,1], bb[2,2]))
```
...
p + 
  geom_sf(
    data = sf::st_as_sf(df.gis_wsp$`2016100606_wsp64knt120hr_halfDeg`), 
    aes(color = PWIND120)
  ) +
  coord_sf(xlim = c(bb[1,1], bb[1,2]), ylim = c(bb[2,1], bb[2,2]))
```
