...
There is a pretty wide field of view on the map above. You can use `sf::st_as_sfc.bbox` to "zoom in" on the map.
...
bb <- sf::st_as_sfc.bbox(df.gis_storm_surge$al142016_2016100618_gt0)
```
...
bb <- sf::st_as_sfc.bbox(df.gis_wind_radii$al142016_2016100606_forecastradii)
```
...
bb <- sf::st_as_sfc.bbox(df.gis_wsp$`2016100606_wsp34knt120hr_halfDeg`)
p + 
  geom_sf(
...
bb <- sf::st_as_sfc.bbox(df.gis_wsp$`2016100606_wsp50knt120hr_halfDeg`)
p + 
  geom_sf(
...
bb <- sf::st_as_sfc.bbox(df.gis_wsp$`2016100606_wsp64knt120hr_halfDeg`)
p + 
  geom_sf(
