...
[![Build Status](https://travis-ci.org/timtrice/Hurricanes.svg?branch=issues-36)](https://travis-ci.org/timtrice/Hurricanes)
[![codecov](https://codecov.io/gh/timtrice/Hurricanes/branch/issues-36/graph/badge.svg)](https://codecov.io/gh/timtrice/Hurricanes)
...
badgecreatr::badgeplacer(githubaccount = "timtrice", githubrepo = "Hurricanes", branch = "issues-36")
```
