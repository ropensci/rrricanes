...
[![Build Status](https://travis-ci.org/timtrice/Hurricanes.svg?branch=master)](https://travis-ci.org/timtrice/Hurricanes)
[![codecov](https://codecov.io/gh/timtrice/Hurricanes/branch/master/graph/badge.svg)](https://codecov.io/gh/timtrice/Hurricanes)
...
[![Last-changedate](https://img.shields.io/badge/last%20change-`r gsub('-', '--', Sys.Date())`-yellowgreen.svg)](/commits/develop)
...
badgecreatr::badgeplacer(githubaccount = "timtrice", githubrepo = "Hurricanes", branch = "develop-0.1.0")
```
