...
## ---- * 1998, EP, 08 ---------------------------------------------------------
ep081998.fstadv <- get_fstadv(ep1998[8])
save(ep081998.fstadv, file = "./inst/extdata/ep081998.fstadv.Rda", compression_level = 9)
...
## ---- * 2006, AL, 04 ---------------------------------------------------------
al042006.wndprb <- get_wndprb(al2006[4])
save(al042006.wndprb,
     file = "./inst/extdata/al042006.wndprb.Rda", compression_level = 9)
