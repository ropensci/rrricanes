...
devtools::use_data(df.al_2012, df.al_18_2012_fstadv, df.al_18_2012, df.al_12_2005_prblty,
...
devtools::use_data(df.gis_adv, df.gis_storm_surge, df.gis_wind_radii, df.gis_wsp)
